...
public class ElementUtils {
	...
	public void doSendKeys(By locator, String value) {
		if (value == null) {
			throw new ElementExceptions("===Invalid String value. Null Not Allowed.===");
		} else {
...
// ************************Actions class Methods ****************************	
	...
	public void menuSubMenuHandlingLevel4(By parentMenuLocator, By subMenu1Locator, By subMenu2Locator,
		...
		act.moveToElement(getElement(subMenu3Locator)).click(driver.findElement(subMenu3Locator)).perform();
